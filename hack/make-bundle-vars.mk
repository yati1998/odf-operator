...
CSI_ADDONS_BUNDLE_IMG_TAG ?= latest
CSI_ADDONS_BUNDLE_IMG_LOCATION ?= quay.io/csiaddons/k8s-bundle
CSI_ADDONS_BUNDLE_IMG ?= $(CSI_ADDONS_BUNDLE_IMG_LOCATION):$(CSI_ADDONS_IMAGE_TAG)
CSI_ADDONS_BUNDLE_NAME ?= csi-addons
...
BUNDLE_IMGS ?= $(shell echo $(BUNDLE_IMG) $(OCS_BUNDLE_IMG) $(IBM_BUNDLE_IMG) $(CSI_ADDONS_BUNDLE_IMG) $(NOOBAA_BUNDLE_IMG) | sed "s/ /,/g")
...
CSI_ADDONS_SUBSCRIPTION_CATALOGSOURCE ?= $(OPERATOR_CATALOGSOURCE)
CSI_ADDONS_SUBSCRIPTION_CATALOGSOURCE_NAMESPACE ?= $(OPERATOR_NAMESPACE)
CSI_ADDONS_SUBSCRIPTION_CHANNEL ?= $(DEFAULT_CHANNEL)
CSI_ADDONS_SUBSCRIPTION_NAME ?= $(CSI_ADDONS_BUNDLE_NAME)
CSI_ADDONS_SUBSCRIPTION_PACKAGE ?= $(CSI_ADDONS_BUNDLE_NAME)
CSI_ADDONS_SUBSCRIPTION_STARTINGCSV ?= $(CSI_ADDONS_BUNDLE_NAME).$(CSI_ADDONS_BUNDLE_IMG_TAG)
